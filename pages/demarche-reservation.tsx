        ...
        <Stack spacing={4} alignItems="center" textAlign="center">
          ...
          <Box>
            ...
            <Typography variant="body1" color="text.secondary">
              Vous souhaitez réserver l’un de nos chatons ? Voici les étapes à suivre afin que votre
              demande soit prise en compte dans les meilleures conditions.
            </Typography>
          </Box>
          ...
          >
            ...
            <Stack spacing={3} mt={3}>
              ...
              <Box>
                ...
                <Typography variant="body1" color="text.secondary">
                  Un acompte de 400 € est demandé afin de rendre la réservation officielle. Tant que
                  les documents signés et l’acompte ne sont pas reçus, le chaton ne peut pas être
          ...
          >
            ...
            <Typography variant="body1" color="text.secondary" mb={4}>
              Les deux documents sont nécessaires pour commencer la démarche de réservation.
            </Typography>
          ...
          >
            ...
            >
              La réservation devient officielle uniquement après réception des deux documents signés
              et du versement de l’acompte de <strong>400 €</strong>.
            </Typography>
          </Box>
        </Stack>
      </Box>
